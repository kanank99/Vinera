...
function Footer() {
  return (
    <div className='dark:bg-[#000212] min-h-[450px] md:min-h-[320px] font-display pb-5'>
        <hr className='border-[#424347] w-full' />
        <div className='flex flex-col items-center justify-center'>
            {/* Explore */}
            <div className='lg:pt-24 lg:flex lg:flex-row lg:justify-between lg:items-center lg:gap-10 w-[90%] max-w-[1600px]'>
                <div className='md:flex md:flex-row md:justify-between md:items-center md:gap-10 w-[90%] max-w-[1200px] m-auto mt-20 lg:mt-0'>
                    <div className='text-[#f7f7f7] flex flex-col lg:h-[250px] text-2xl w-full mt-14 lg:mt-0'>
                        <div>
                ...
                <div className='md:flex md:flex-row md:justify-between md:items-center md:gap-10 w-[90%] max-w-[1200px] m-auto mt-20 lg:mt-0'>
                    <div className='text-[#f7f7f7] flex flex-col lg:h-[250px] text-2xl w-full mt-14 lg:mt-0'>
                        ...
                        <div className='flex flex-row justify-center items-center gap-5 transition-all'>
        ...
        <div className='flex flex-col items-center justify-center mt-20 md:mt-10 lg:mt-0'>
            <div className='text-[#8a8f98] text-xl'>© 2023 Vinera AI. All rights reserved.</div>
        </div>
    </div>
  )
}
