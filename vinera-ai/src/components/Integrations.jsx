...
function Integrations(props) {
  ...
  return (
    <div className='bg-[#fff] dark:bg-[#000212] min-h-[500px] font-display'>
        ...
        <div className='w-full h-full'>
            <div className='max-w-7xl mx-auto py-16 sm:py-24 lg:px-8 flex flex-col '>
                <div className='relative flex flex-row justify-center items-center gap-3 lg:gap-5 py-20'>
                    ...
                    <div className='noShowBall ball flex items-center justify-center h-24 w-24 lg:h-40 lg:w-40 rounded-full bg-gradient-to-tr from-green-600 to-green-900 dark:from-blue-500 dark:via-[#435674] dark:to-purple-600 text-white'>
