            ...
            <div className='w-full h-full'>
                <div className='max-w-7xl mx-auto py-16 sm:py-24 lg:px-8 flex flex-col '>
                    <div className='relative flex flex-row justify-center items-center gap-3 lg:gap-5 py-20'>
                        ...
                        <div className='noShowBall ball md:flex md:items-center md:justify-center hidden md:w-14 md:h-14 lg:h-20 lg:w-20 md:rounded-full md:bg-[#000212] md:dark:bg-[#ffffff0F] md:text-white border-2 border-solid border-[#ffffff0D]'>
                            <img src={Sheets} alt='google-sheets-icon' className='hidden md:flex md:w-6 md:h-8 lg:w-8 lg:h-12' />
                        </div>
                        <div className='noShowBall ball flex items-center justify-center h-16 w-16 lg:h-24 lg:w-24 rounded-full bg-[#000212] dark:bg-[#ffffff0F] text-white border-2 border-solid border-[#ffffff0D]'>
                            <img src={Facebook} alt='facebook-icon' className='w-10 h-10 lg:w-12 lg:h-12' />
                        </div>
                        <div className='noShowBall ball flex items-center justify-center h-20 w-20 lg:h-32 lg:w-32 rounded-full bg-[#000212] dark:bg-[#ffffff0F] text-white border-2 border-solid border-[#ffffff0D]'>
                            <img src={Mailchimp} alt='mailchimp-icon' className='w-10 h-10 lg:w-20 lg:h-20' />
                        </div>
                        ...
                        <div className='noShowBall ball flex items-center justify-center h-20 w-20 lg:h-32 lg:w-32 rounded-full bg-[#ffffff0F] text-white border-2 border-solid border-[#ffffff0D]'>
                            <img src={Gmail} alt='gmail-icon' className='w-10 h-10 lg:w-16 lg:h-16' />
                        </div>
                        <div className='noShowBall ball flex items-center justify-center h-16 w-16 lg:h-24 lg:w-24 rounded-full bg-[#ffffff0F] text-white border-2 border-solid border-[#ffffff0D]'>
                            <img src={Drive} alt='drive-icon' className='w-10 h-10 lg:w-14 lg:h-14' />
                        </div>
                        <div className='noShowBall ball md:flex md:items-center md:justify-center hidden md:w-14 md:h-14 lg:h-20 lg:w-20 md:rounded-full md:bg-[#ffffff0F] md:text-white border-2 border-solid border-[#ffffff0D]'>
                            <img src={Slack} alt='drive-icon' className='hidden md:flex md:w-7 md:h-7 lg:w-10 lg:h-10' />
                        </div>
