        ...
        <div className='header-transparency transition-all text-[#191c1d] fixed w-full flex justify-between h-20 border-b-[1px] border-b-[#27282b] items-center pl-4 pr-4 lg:pl-20 lg:pr-20 z-30'>
            ...
            <div className='flex gap-5 z-10'>
                ...
                <div className='hidden sm:flex sm:gap-5 lg:gap-10 sm:items-center sm:justify-center'>
                    ...
                    <div className='hidden lg:flex text-[#313435] dark:text-[#f7f7f7] dark:hover:text-[#8a8f98] transition-all text-xl h-full cursor-pointer justify-center items-center gap-2'><p className='tracking-tight'>Solutions</p><img src={Dropdown} alt='dropdown' className='w-5 h-5' /></div>
