...
function Whyus(props) {
  ...
  return (
      <div id='whyus' className={`whyusdiv flex lg:flex-col lg:gap-24 items-center justify-center relative sm:h-[50dvh] md:h-[70dvh] lg:h-[100dvh] min-h-[900px] ${props.darkMode ? "dark-testing-2" : "light-bg"}  font-display z-40`}>
