...
function Whyus(props) {
  ...
  return (
    <div id='whyus' className={`whyusdiv flex flex-col  items-center justify-center relative ${props.darkMode ? "dark-testing-2" : "light-bg"}  font-display z-40`}>
      <motion.div className='text-[#f7f7f7] text-5xl w-full py-8 lg:py-14'
      ...
      <div class="max-w-[85rem] px-4 pt-24 sm:px-6 lg:px-8 lg:pb-2 lg:pt-24 mx-auto font-display">
        ...
        <div class="lg:grid lg:grid-cols-12 lg:gap-16 lg:items-center lg:justify-between">
          <div class="lg:col-span-5 lg:col-start-1">
            {/* <!-- Title --> */}
            <div class="mb-8">
              <motion.h2 class="text-center lg:text-left mb-2 text-3xl text-gray-800 font-bold lg:text-4xl dark:text-gray-200"
                initial={{ opacity: 0, y: 25, scale: 0.9 }}
                whileInView={{ opacity: 1, y: 0, scale: 1 }}
                transition={{
                  duration: 0.6,
              ...
              <motion.p class="text-center lg:text-left text-gray-600 dark:text-gray-400 mt-[25px]"
                initial={{ opacity: 0, y: 25, scale: 0.9 }}
                whileInView={{ opacity: 1, y: 0, scale: 1 }}
                transition={{
                  duration: 0.6,
            ...
            {/* <!-- Blockquote --> */}
            <motion.blockquote class="relative"
              initial={{ opacity: 0, y: 25, scale: 0.9 }}
              whileInView={{ opacity: 1, y: 0, scale: 1 }}
              transition={{
                duration: 0.6,
          ...
          <div class="mt-10 lg:mt-0 lg:col-span-6 lg:col-end-13">
            <div class="space-y-6 sm:space-y-8">
              ...
              <ul class="grid grid-cols-2 divide-y divide-y-2 divide-x divide-x-2 divide-gray-200 overflow-hidden dark:divide-gray-700">
                <motion.li class="flex flex-col -m-0.5 p-4 sm:p-8"
                  initial={{ opacity: 0, y: 25, scale: 0.9 }}
                  whileInView={{ opacity: 1, y: 0, scale: 1 }}
                  transition={{
                    duration: 0.6,
                ...
                <motion.li class="text-left flex flex-col -m-0.5 p-4 sm:p-8"
                  initial={{ opacity: 0, y: 25, scale: 0.9 }}
                  whileInView={{ opacity: 1, y: 0, scale: 1 }}
                  transition={{
                    duration: 0.6,
      ...
      <div class="mb-5 mt-32 relative block isolate ">
        <a className="anchor" href="#savingsCalc">
          <div class="button-why-us font-bold">Savings Calculator</div>
          <div class="button_bg-grad"></div>
        </a>
        <span class="absolute lg:-top-16 left-auto lg:-right-40 -right-12 -top-[3.2rem] scale-125">
          <span class="flex items-center">
            <svg class="scale-125" width="45" height="25" viewBox="0 0 45 25" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <span class="mt-3 inline-block whitespace-nowrap text-[13px] leading-5 font-normal tracking-wide text-white">Calculate your ROI</span>
          </span>
        </span>
      </div>
      <div className='pt-20'>
        <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-6 mx-auto">
          ...
          <div class="flex flex-col items-center md:flex-row justify-center gap-x-6 sm:gap-x-12 lg:gap-x-24">
            ...
            <div class="flex gap-[7rem]">
              ...
              <img class="py-3 lg:py-5 w-16 scale-[2.5] md:scale-[1] h-auto md:w-20 lg:w-40 mx-auto sm:mx-0 text-gray-500" src={BotpressSVG} alt="" />
            </div>
